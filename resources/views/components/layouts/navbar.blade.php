	...
	<nav class="nav">
		<div>
			...
			<div class="nav_list">
				...
				<a href="{{route('restaurantes.index')}}" class="nav_link"> <i class='bx bx-receipt nav_icon'></i> <span class="nav_name">Locales</span> </a>
				<a href="{{route('platos.index')}}" class="nav_link"> <i class='bx bx-search nav_icon'></i> <span class="nav_name">Platos</span> </a>
